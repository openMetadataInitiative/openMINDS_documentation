...
.. csv-table:: subjects_case-01.csv
   :file: ../../_static/test-data/subjects_case-01.csv
...
.. code-block:: python
   ...
   with open('subjects_case-01.csv', 'r') as f:
...
.. csv-table:: subjects_case-02.csv
   :file: ../../_static/test-data/subjects_case-02.csv
   :widths: 10, 10, 10, 10, 10
   :header-rows: 1
...
.. code-block:: python
   ...
   # read csv file to a list of dictionaries
   with open('subjects_case-02.csv', 'r') as f:
       csv_reader = csv.DictReader(f)
       data = [row for row in csv_reader]
   f.close()
