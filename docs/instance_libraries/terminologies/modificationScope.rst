########################################
Terminologies: ModificationScope library
########################################

Related schema specification: `ModificationScope <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/controlledTerms/modificationScope.html>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ModificationScope
...
`BACK TO TOP <Terminologies: ModificationScope library_>`_

------------

financialModification
---------------------
