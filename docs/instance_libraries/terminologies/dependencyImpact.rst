...
Related schema specification: `DependencyImpact <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/dependencyImpact.html>`_
...
`BACK TO TOP <Terminologies: DependencyImpact library_>`_
