...
Related schema specification: `SpatialEncoding <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/controlledTerms/spatialEncoding.html>`_
...
.. admonition:: metadata sheet
   ...
   :synonym: 1D frequency encoding, single-dimensional frequency encoding
...
.. admonition:: metadata sheet
   ...
   :synonym: 1D phase encoding, single-dimensional phase encoding
...
.. admonition:: metadata sheet
   ...
   :synonym: 3D frequency-phase-phase encoding, three-dimensional frequency and dual-phase encoding
...
.. admonition:: metadata sheet
   ...
   :synonym: 2D frequency-phase encoding, two-dimensional frequency and phase encoding
