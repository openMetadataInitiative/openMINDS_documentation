#############################################
Terminologies: ModificationConstraint library
#############################################

Related schema specification: `ModificationConstraint <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/controlledTerms/modificationConstraint.html>`_

------------

------------

cooling-offPeriodRequired
-------------------------
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ModificationConstraint
   :definition: A mandatory delay applies before a modification becomes effective.
   :name: cooling-off period required

`BACK TO TOP <Terminologies: ModificationConstraint library_>`_
