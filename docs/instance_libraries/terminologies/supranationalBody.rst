########################################
Terminologies: SupranationalBody library
########################################

Related schema specification: `SupranationalBody <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/supranationalBody.html>`_
