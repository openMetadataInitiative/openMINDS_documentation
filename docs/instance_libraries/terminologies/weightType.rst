#################################
Terminologies: WeightType library
#################################

Related schema specification: `WeightType <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/controlledTerms/weightType.html>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/WeightType
   :definition: The mass of an intact organism measured as a whole.
   :name: body weight

`BACK TO TOP <Terminologies: WeightType library_>`_
