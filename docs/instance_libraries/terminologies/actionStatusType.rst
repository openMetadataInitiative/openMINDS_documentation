...
Related schema specification: `ActionStatusType <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/controlledTerms/actionStatusType.html>`_
...
.. admonition:: metadata sheet
   ...
   :synonym: active action, active action status
...
.. admonition:: metadata sheet
   ...
   :synonym: completed action, completed action status, finished successfully
...
.. admonition:: metadata sheet
   ...
   :synonym: error, failed action, failed action status, finished unsuccessfully
...
.. admonition:: metadata sheet
   ...
   :name: inactive
   :synonym: inactive action, inactive action status
...
.. admonition:: metadata sheet
   ...
   :name: paused
   :synonym: paused action, paused action type, suspended
...
.. admonition:: metadata sheet
   ...
   :name: pending
   :synonym: pending action, pending action type, queued
...
.. admonition:: metadata sheet
   ...
   :synonym: potential action, potential action type
