########################################
Terminologies: PublicationStatus library
########################################

Related schema specification: `PublicationStatus <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/publicationStatus.html>`_
