#######################################
Terminologies: PaymentModelType library
#######################################

Related schema specification: `PaymentModelType <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/paymentModelType.html>`_
...
`BACK TO TOP <Terminologies: PaymentModelType library_>`_
