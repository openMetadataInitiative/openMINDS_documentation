##################################
Terminologies: ProjectType library
##################################

Related schema specification: `ProjectType <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/projectType.html>`_
...
`BACK TO TOP <Terminologies: ProjectType library_>`_
