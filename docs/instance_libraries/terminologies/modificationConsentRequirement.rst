#####################################################
Terminologies: ModificationConsentRequirement library
#####################################################

Related schema specification: `ModificationConsentRequirement <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/modificationConsentRequirement.html>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ModificationConsentRequirement
   :definition: Modification is permitted based on prior standing consent given in the original agreement.
   :name: advance consent

`BACK TO TOP <Terminologies: ModificationConsentRequirement library_>`_
