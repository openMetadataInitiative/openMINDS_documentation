###################################
Terminologies: AgeReference library
###################################

Related schema specification: `AgeReference <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/ageReference.html>`_
...
.. admonition:: metadata sheet
   ...
   :@id: https://openminds.om-i.org/instances/ageReference/birth
...
.. admonition:: metadata sheet
   ...
   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/ageReference/death
   :@type: https://openminds.om-i.org/types/AgeReference
...
.. admonition:: metadata sheet
   ...
   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/ageReference/fertilization
   :@type: https://openminds.om-i.org/types/AgeReference
...
firstDayOfTheLastMenstrualPeriod
--------------------------------

.. admonition:: metadata sheet

   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/ageReference/firstDayOfTheLastMenstrualPeriod
   :@type: https://openminds.om-i.org/types/AgeReference
