#########################################
Terminologies: ExternalBodyRegion library
#########################################

Related schema specification: `ExternalBodyRegion <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/externalBodyRegion.html>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ExternalBodyRegion
   ...
   :name: face
   :preferredOntologyIdentifier: http://purl.obolibrary.org/obo/UBERON_0001456
...
.. admonition:: metadata sheet
   ...
   :name: neck
   :preferredOntologyIdentifier: http://purl.obolibrary.org/obo/UBERON_0000974
