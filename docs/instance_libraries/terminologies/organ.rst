...
.. admonition:: metadata sheet
   ...
   :definition: 'Brain' is part of the central nervous system. [auto-generated from 'relationship' property of the [UBERON ontology term](http://purl.obolibrary.org/obo/UBERON_0000955)]
   ...
   :name: brain
   :otherOntologyIdentifier: http://uri.interlex.org/base/ilx_0101431
...
.. admonition:: metadata sheet
   ...
   :name: heart
   :otherOntologyIdentifier: http://uri.interlex.org/base/ilx_0732254
   :preferredCrossReference: https://knowledge-space.org/wiki/UBERON:0000948#heart
...
.. admonition:: metadata sheet
   ...
   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/organ/insectAdultBrain
   :@type: https://openminds.om-i.org/types/Organ
...
.. admonition:: metadata sheet
   ...
   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/organ/insectEmbryonicBrain
   :@type: https://openminds.om-i.org/types/Organ
...
.. admonition:: metadata sheet
   ...
   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/organ/insectEmbryonicLarvalBrain
   :@type: https://openminds.om-i.org/types/Organ
...
.. admonition:: metadata sheet
   ...
   :name: liver
   :otherOntologyIdentifier: http://uri.interlex.org/base/ilx_0725629
   :preferredCrossReference: https://knowledge-space.org/wiki/UBERON:0002107#liver
...
.. admonition:: metadata sheet
   ...
   :name: muscle
   :otherOntologyIdentifier: http://uri.interlex.org/base/ilx_0107218
...
.. admonition:: metadata sheet
   ...
   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/organ/neuroendocrineGland
   :@type: https://openminds.om-i.org/types/Organ
...
.. admonition:: metadata sheet
   ...
   :name: skin
   :otherOntologyIdentifier: http://uri.interlex.org/base/ilx_0727256
   :preferredCrossReference: https://knowledge-space.org/wiki/UBERON:0002097#skin-of-body
...
.. admonition:: metadata sheet
   ...
   :@context: @vocab: <https://openminds.om-i.org/props/>
   :@id: https://openminds.om-i.org/instances/organ/spinalCord
   :@type: https://openminds.om-i.org/types/Organ
