####################################
Terminologies: AccessChannel library
####################################

Related schema specification: `AccessChannel <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/accessChannel.html>`_
