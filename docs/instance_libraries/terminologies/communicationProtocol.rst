############################################
Terminologies: CommunicationProtocol library
############################################

Related schema specification: `CommunicationProtocol <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/communicationProtocol.html>`_
