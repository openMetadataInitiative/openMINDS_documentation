###########################################
Terminologies: SignalDirectionality library
###########################################

Related schema specification: `SignalDirectionality <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/controlledTerms/signalDirectionality.html>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/SignalDirectionality
   ...
   :synonym: receive-only, receiving

`BACK TO TOP <Terminologies: SignalDirectionality library_>`_
...
.. admonition:: metadata sheet
   ...
   :synonym: transceiving, transmitting–receiving, transmit–receive
...
.. admonition:: metadata sheet
   ...
   :synonym: transmit-only, transmitting
