##################################
CommonCoordinateFrameworks library
##################################

Related schema specification: `CommonCoordinateFramework <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/SANDS/atlas/commonCoordinateFramework.html>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/CommonCoordinateFramework
...
`BACK TO TOP <CommonCoordinateFrameworks library_>`_
...
.. admonition:: metadata sheet
   ...
   :usedTaxon: `macacaMulatta <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/terminologies/species.html#macacamulatta>`_
