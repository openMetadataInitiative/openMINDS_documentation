#############################################################
CommonCoordinateFrameworkVersions: P-MarmosetBSC-corT library
#############################################################
...
.. admonition:: metadata sheet
   ...
   :documentation: https://openminds.om-i.org/instances/ISBN/978-0-12-415818-4
   ...
   :isVersionOf: `P-MarmosetBSC-corT <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/commonCoordinateFrameworks.html#p-marmosetbsc-cort>`_
   ...
   :versionSpecification: This is the first version of this stereotaxic coordinate system.

`BACK TO TOP <CommonCoordinateFrameworkVersions: P-MarmosetBSC-corT library_>`_
