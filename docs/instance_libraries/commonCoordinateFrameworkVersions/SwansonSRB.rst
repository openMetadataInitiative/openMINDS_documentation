#####################################################
CommonCoordinateFrameworkVersions: SwansonSRB library
#####################################################
...
.. admonition:: metadata sheet
   ...
   :isVersionOf: `SwansonSRB <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/commonCoordinateFrameworks.html#swansonsrb>`_
   ...
   :versionSpecification: This is the first version of this common coordinate space.

`BACK TO TOP <CommonCoordinateFrameworkVersions: SwansonSRB library_>`_
