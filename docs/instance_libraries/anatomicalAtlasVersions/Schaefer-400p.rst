##############################################
AnatomicalAtlasVersions: Schaefer-400p library
##############################################
...
.. admonition:: metadata sheet
   ...
   :isVersionOf: `Schaefer-400p <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/anatomicalAtlases.html#schaefer-400p>`_
   ...
   :usageCondition: `MIT <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/licenses.html#mit>`_
   :versionIdentifier: 2018, FSL-MNI152, kong17n

`BACK TO TOP <AnatomicalAtlasVersions: Schaefer-400p library_>`_
...
.. admonition:: metadata sheet
   ...
   :abbreviation: Schaefer-400p
   :accessibility: `directVirtualOpenAccess <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/accessibilities.html#directvirtualopenaccess>`_
   :coordinateFramework: `fsLR_32k <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/commonCoordinateFrameworkVersions/fsLR.html#fslr-32k>`_
   :fullName: Schaefer Atlas with 400 Parcellation
   :hasTerminology: NOT DEFINED YET
   :isVersionOf: `Schaefer-400p <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/anatomicalAtlases.html#schaefer-400p>`_
   :majorVersionIdentifier: 2018
