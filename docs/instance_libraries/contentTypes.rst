...
.. admonition:: metadata sheet
   ...
   :synonym: Level 4 MAT-file format, MAT
...
.. admonition:: metadata sheet
   ...
   :synonym: Level 5 MAT-file format, MAT
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/dicom
   :fileExtension: .dcm
   :name: application/dicom
   :synonym: DICOM, Digital Imaging and Communications in Medicine
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/gzip
   ...
   :fileExtension: .gz, .gzip
   :name: application/gzip
   :specification: https://www.ietf.org/rfc/rfc1952.txt
   :synonym: GNU zip, GNU zip file, GZ file, GZIP, GZIP file
...
.. admonition:: metadata sheet
   ...
   :synonym: JSON, JavaScript Object Notation
...
.. admonition:: metadata sheet
   ...
   :isBasedOn: `application_json <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#application-json>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/octet-stream
   :fileExtension: .bin
   :name: application/octet-stream
   :synonym: BIN, binary format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/pdf
   :fileExtension: .pdf
   :name: application/pdf
   :specification: https://www.pdfa.org/resource/iso-32000-2-pdf-2-0/
   :synonym: Adobe Portable Document Format, PDF
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .sbml
   :isBasedOn: `application_xml <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#application-xml>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .brik, .head
   :name: application/vnd.afni
   :synonym: AFNI medical imaging data
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .am, .amiramesh, .grey, .hx, .labels
...
.. admonition:: metadata sheet
   ...
   :synonym: Analysis Services Backup File
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .cas, .dat
   :name: application/vnd.ansysfluent
   :synonym: ANSYS Fluent
...
.. admonition:: metadata sheet
   ...
   :synonym: ANTs Linear Transformation
...
.. admonition:: metadata sheet
   ...
   :isBasedOn: `application_x-hdf <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#application-x-hdf>`_
...
.. admonition:: metadata sheet
   ...
   :synonym: AnyWave Descriptive Format
...
.. admonition:: metadata sheet
   ...
   :synonym: Unstructured Cell Data
...
.. admonition:: metadata sheet
   ...
   :synonym: BIDS electrodes format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .bngl, .ebngl
   :name: application/vnd.bionetgen
   :synonym: BioNetGen Language
...
.. admonition:: metadata sheet
   ...
   :synonym: Blackrock Neural Events
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 1
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 2
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 3
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 4
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 5
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 6
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 7
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 8
...
.. admonition:: metadata sheet
   ...
   :specification: https://blackrockneurotech.com/research/wp-content/ifu/LB-0023-7.00_NEV_File_Format.pdf
   :synonym: Blackrock Neural Signals 9
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .nev, .ns1, .ns2, .ns3, .ns4, .ns5, .ns6, .ns7, .ns8, .ns9
   :name: application/vnd.blackrockmicrosystems.parallelrecordings
   :synonym: Blackrock Parallel Recordings
...
.. admonition:: metadata sheet
   ...
   :synonym: BrainVision Binary Data, BrainVision Data Exchange Binary Data File
...
.. admonition:: metadata sheet
   ...
   :synonym: BrainVision Data Exchange Header File, BrainVision Header
...
.. admonition:: metadata sheet
   ...
   :synonym: BrainVision Data Exchange Marker File, BrainVision Marker
...
.. admonition:: metadata sheet
   ...
   :synonym: Paraver Configuration File
...
.. admonition:: metadata sheet
   ...
   :synonym: CWL command line tool, CWL command-line wrapper description
...
.. admonition:: metadata sheet
   ...
   :synonym: CWL workflow description
...
.. admonition:: metadata sheet
   ...
   :synonym: EBRAINS image-service Deep Zoom specs, EBRAINS image-service with Deep Zoom specifications
...
.. admonition:: metadata sheet
   ...
   :synonym: EBRAINS image-service Neuroglancer precomputed specs, EBRAINS image-service with Neuroglancer precomputed specifications
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .eeg, .eeg.ent
   :name: application/vnd.elan.continuous-data
   :synonym: ELAN continuous data file
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .case, .sos
   :name: application/vnd.ensight
   :synonym: Engineering inSight
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .xls
   :isBasedOn: `application_vnd.ms-excel <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#application-vnd-ms-excel>`_
...
.. admonition:: metadata sheet
   ...
   :synonym: EsPINA Segmentation file, EspINA Interactive Neuron Analyzer Segmentation file
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .0, .00, .000, .0000, .e, .ex2, .ex2v2, .exii, .exo, .exoii, .g, .gen
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .dtseries.nii, .nii.gz
...
.. admonition:: metadata sheet
   ...
   :synonym: FreeSurfer Annotation File
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .inflated, .mgh, .mgz, .orig, .pial, .smoothwm, .sphere, .white
...
.. admonition:: metadata sheet
   ...
   :synonym: odML, open metadata Markup Language
...
.. admonition:: metadata sheet
   ...
   :synonym: Gatan Digital Micrograph 2
...
.. admonition:: metadata sheet
   ...
   :synonym: Object Oriented Graphics Library
...
.. admonition:: metadata sheet
   ...
   :synonym: Hamamatsu Aquacosmos NAF
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .ndpi, .ndpis
   :name: application/vnd.hamamatsu.ndpi
   :synonym: Hamamatsu ndpi
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .bmp, .jpg, .tif, .txt
   :name: application/vnd.hitachi.s-4800
   :synonym: Hitachi S-4800
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .ics, .ids
   :name: application/vnd.ics
   :synonym: Image Cytometry Standard
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .ibw, .pxp
   :name: application/vnd.igorpro
   :synonym: Igor Binary Waves, Packed Experiment files
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .csv
   :isBasedOn: `text_csv <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#text-csv>`_
...
.. admonition:: metadata sheet
   ...
   :isBasedOn: `text_x-fastq <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#text-x-fastq>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .liff, .raw
   :name: application/vnd.improvision.openlab
   :synonym: Improvision Openlab
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .rhd, .rhs
   :name: application/vnd.intan.technology
   :synonym: Intan tech rhd and rhs files, RHD RHS
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .pts, .txt
   :name: application/vnd.intranat+txt
   :synonym: IntrAnat PTS
...
.. admonition:: metadata sheet
   ...
   :synonym: Khoros Visualization Image File Format Bitmap
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .ptvi, .pvtb, .pvtp, .pvtr, .pvts, .pvtu
...
.. admonition:: metadata sheet
   ...
   :synonym: LIM (Laboratory Imaging/Nikon)
...
.. admonition:: metadata sheet
   ...
   :synonym: Lambert Instruments FLIM
...
.. admonition:: metadata sheet
   ...
   :synonym: Leica LAS AF LIF (Leica Image File Format)
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .lei, .tiff
   :name: application/vnd.leica.lcs.lei
   :synonym: Leica LCS LEI
...
.. admonition:: metadata sheet
   ...
   :synonym: Open Document Spreadsheet
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .d3plot
   :name: application/vnd.ls-dyna
   :synonym: LS-DYNA D3PLOT
...
.. admonition:: metadata sheet
   ...
   :synonym: MATLAB Live, MATLAB Live Script, MATLAB Live-Script, MATLAB MLX
...
.. admonition:: metadata sheet
   ...
   :synonym: MEA, Multi-Electrode-Arrays
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .nd, .stk
   :name: application/vnd.metamorph.stack
   :synonym: MetaMorph Stack
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .tiff, .txt, .xml
   :name: application/vnd.micro-manager
   :synonym: Micro-Manager
...
.. admonition:: metadata sheet
   ...
   :synonym: Axon™ Binary File format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .ali, .map, .mrc, .mrcs, .rec, .st
   :name: application/vnd.mrc
   :synonym: MRC (Medical Research Council)
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .mif, .mif.gz, .mih
   :name: application/vnd.mrtrix.imageformat
   :synonym: MRTrix Image Format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .msf, .msh
   :name: application/vnd.mrtrix.legacysparseformat
   :synonym: Legacy MRtrix Sparse Format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/vnd.ms-excel
   :fileExtension: .xls
   :name: application/vnd.ms-excel
   :synonym: Microsoft Excel, XLS
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .asc, .csv, .tsv, .txt
   :name: application/vnd.neo.ascii.signal
   :synonym: NEO AnalogSignals
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .pbm, .pgm, .ppm
   :name: application/vnd.netpbm.portableanymap
   :synonym: Portable Anymap
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .ncs, .nev, .nse, .ntt
   :name: application/vnd.neuralynx
   :synonym: Neuralynx files
...
.. admonition:: metadata sheet
   ...
   :specification: https://github.com/google/neuroglancer/blob/33d5206cf16c60530e9d0d517dc8bb9b968e2e18/src/neuroglancer/datasource/precomputed/README.md
   :synonym: Neuroglancer precomputed
...
.. admonition:: metadata sheet
   ...
   :specification: https://github.com/google/neuroglancer/blob/33d5206cf16c60530e9d0d517dc8bb9b968e2e18/src/neuroglancer/datasource/precomputed/README.md
   :synonym: Neuroglancer precomputed raw
...
.. admonition:: metadata sheet
   ...
   :synonym: NeuroScope format files
...
.. admonition:: metadata sheet
   ...
   :synonym: Neuroshare compatible files
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .hdr, .img, .nii, .nii.gz
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .nef, .tiff
   :name: application/vnd.nikon.nef
   :synonym: Nikon Electronic Format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .nhdr, .nrrd, .raw, .txt
   :name: application/vnd.nrrd
   :synonym: Nearly Raw Raster Data
...
.. admonition:: metadata sheet
   ...
   :synonym: Nutil Analysis Parameters
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .apl, .mtb, .obsep, .tiff, .tnb
   :name: application/vnd.olympus.cellr-apl
   :synonym: Olympus CellR/APL
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .oib, .oif
   :name: application/vnd.olympus.fluoview.fv1000
   :synonym: Olympus FluoView FV1000
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .dat, .tiff, .xml
   :name: application/vnd.olympus.scanr
   :synonym: Olympus ScanR
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .ome.btf, .ome.tf2, .ome.tf8, .ome.tiff
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/vnd.openxmlformats-officedocument.spreadsheetml.sheet
   :fileExtension: .xlsx
   :name: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet
   :synonym: Microsoft Excel (Open XML), XLSX
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/vnd.openxmlformats-officedocument.wordprocessingml.document
   :fileExtension: .docx
   :name: application/vnd.openxmlformats-officedocument.wordprocessingml.document
   :synonym: DOCX, Microsoft Word (OpenXML)
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .csv, .tiff, .xml
   :name: application/vnd.perkinelmer.columbus
   :synonym: PerkinElmer Columbus
...
.. admonition:: metadata sheet
   ...
   :synonym: PerkinElmer Densitometer
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .flex, .mea, .res
   :name: application/vnd.perkinelmer.evotec
   :synonym: Evotec/PerkinElmer Opera Flex
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .tiff, .xml
   :name: application/vnd.perkinelmer.operetta
   :synonym: PerkinElmer Operetta
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .2, .3, .4, .tiff
   :name: application/vnd.perkinelmer.ultraview
   :synonym: PerkinElmer UltraVIEW
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .qptiff, .tiff
   :name: application/vnd.perkinelmer.vectra
   :synonym: PerkinElmer Vectra QPTIFF
...
.. admonition:: metadata sheet
   ...
   :synonym: RenderMan Interface Bytestream
...
.. admonition:: metadata sheet
   ...
   :synonym: Plexon acquisition system
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .cfg, .tiff, .xml
   :name: application/vnd.prairie-technologies
   :synonym: Prairie Technologies TIFF
...
.. admonition:: metadata sheet
   ...
   :synonym: Princeton Instruments SPE
...
.. admonition:: metadata sheet
   ...
   :synonym: MCS, Raw Multi Channel System, RawMCS
...
.. admonition:: metadata sheet
   ...
   :synonym: Raw binary interleaved compact files
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .bif, .tiff
   :name: application/vnd.rochedigitaldiagnostics.ventana
   :synonym: Ventana BIF, Ventana TIFF
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .abf, .abf2, .atf, .axgd, .axgx, .cfs, .hdf5, .heka
   :name: application/vnd.stimfit
   :synonym: Python stfio
...
.. admonition:: metadata sheet
   ...
   :synonym: Tucker David TTank format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .tsv
   :isBasedOn: `text_tab-separated-values <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#text-tab-separated-values>`_
...
.. admonition:: metadata sheet
   ...
   :synonym: Track Scalar File Format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .raw, .v3dpbd, .v3draw
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .2fl, .ffr, .tfr, .zfp, .zfr
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/model/obj
   :fileExtension: .obj
   :name: application/vnd.wavefronttechnologies
   :synonym: Wavefront OBJ
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/model/mtl
   :fileExtension: .mtl
   :name: application/vnd.wavefronttechnologies.mtl
   :synonym: Wavefront MTL
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .xdmf, .xmf
   :name: application/vnd.xdmf
   :synonym: eXtensible Data Model and Format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .zarr, .zarray
   :name: application/vnd.zarr
   :synonym: Zarr format array
...
.. admonition:: metadata sheet
   ...
   :synonym: Blender scene description format
...
.. admonition:: metadata sheet
   ...
   :synonym: HDF5, Hierarchical Data Format version 5
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .cdf, .nc
   :name: application/x-netcdf
   :synonym: Network Common Data Form
...
.. admonition:: metadata sheet
   ...
   :synonym: Extensible Markup Language, XML
...
.. admonition:: metadata sheet
   ...
   :synonym: YAML, Yet Another Markup Language, application/vnd.yaml, application/vnd.yml, application/yml
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/application/zip
   :fileExtension: .zip, .zipx
   :name: application/zip
   :specification: https://pkware.cachefly.net/webdocs/casestudies/APPNOTE.TXT
   :synonym: ZIP, ZIP file, zipfile
...
.. admonition:: metadata sheet
   ...
   :isBasedOn: `text_plain <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#text-plain>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/image/bmp
   :fileExtension: .bmp
   :name: image/bmp
   :synonym: Bitmap image
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .gif
   :name: image/gif
   :synonym: GIF, Graphics Interchange Format
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .jfif, .jif, .jpeg, .jpg, .pjp, .pjpeg
   :name: image/jpeg
   :synonym: JPG JPEG, Joint Photographic Expert Group
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/image/png
   :fileExtension: .png
   :name: image/png
   :synonym: PNG, Portable Network Graphics
...
.. admonition:: metadata sheet
   ...
   :synonym: Andor Bio-Imaging Division (ABD) TIFF
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/image/tiff
   :fileExtension: .tif, .tiff
   :name: image/tiff
   :synonym: Tagged Image File (Tiled)
...
.. admonition:: metadata sheet
   ...
   :synonym: Tagged Image File (Multi channel)
...
.. admonition:: metadata sheet
   ...
   :synonym: Tagged Image File (Multi-page)
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .h5, .hdf5
   :isBasedOn: `image_x-hdf <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#image-x-hdf>`_
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .n5
   :isBasedOn: `image_x-n5 <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/contentTypes.html#image-x-n5>`_
...
.. admonition:: metadata sheet
   ...
   :synonym: ilastik pixel classification image (neuroglancer precomputed)
...
.. admonition:: metadata sheet
   ...
   :synonym: ilastik segmentation image (DZI)
...
.. admonition:: metadata sheet
   ...
   :synonym: ilastik segmentation image (DZIP)
...
.. admonition:: metadata sheet
   ...
   :synonym: ilastik segmentation image (neuroglancer precomputed)
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .bw, .rgb, .rgba
   :name: image/vnd.silicongraphicsimage
   :synonym: Silicon Graphics Image
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :fileExtension: .eps, .epsf, .epsi, .ps
   :name: image/x-eps
   :synonym: EPS, Encapsulated PostScript
...
.. admonition:: metadata sheet
   ...
   :synonym: Panasonic RAW file format
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .csv
   :name: text/csv
   :synonym: CSV, Comma-Separated Value
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/text/html
   :fileExtension: .htm, .html
   :name: text/html
   :synonym: HTML, Hypertext Markup Language
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/text/markdown
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .txt
   :name: text/plain
   :synonym: plain text file format
...
.. admonition:: metadata sheet
   ...
   :synonym: semi-colon separated value
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/text/tab-separated-values
   :fileExtension: .csv, .tsv
   :name: text/tab-separated-values
   :synonym: TSV, Tab-Separated Value
...
.. admonition:: metadata sheet
   ...
   :synonym: FSL b-value format, FSL bval format
...
.. admonition:: metadata sheet
   ...
   :synonym: FSL b-vector format, FSL bvec format
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .m
   :name: text/x-matlab
   :synonym: MATLAB Plain, MATLAB Plain Script
...
.. admonition:: metadata sheet
   ...
   :fileExtension: .m
   :name: text/x-objcsrc
   :synonym: Objective C source file
...
.. admonition:: metadata sheet
   ...
   :@type: https://openminds.om-i.org/types/ContentType
   :definingSource: https://www.iana.org/assignments/media-types/video/mp4
   :fileExtension: .mp4
   :name: video/mp4
   :synonym: MPEG-4, Moving Picture Experts Group 4 video file
...
.. admonition:: metadata sheet
   ...
   :synonym: AVI, Audio Video Interleave
