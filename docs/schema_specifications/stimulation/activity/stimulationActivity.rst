...
:Semantic name: https://openminds.om-i.org/types/StimulationActivity
...
.. admonition:: schema_specifications
   ...
   :semantic name: https://openminds.om-i.org/props/setup
   :value type: | linked object of type
                | `Setup <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/core/products/setup.html>`_
...
.. admonition:: schema_specifications
   ...
   :semantic name: https://openminds.om-i.org/props/stimulus
   :value type: | linked object array \(1-N\) of type
                | `EphysStimulus <https://openminds-documentation.readthedocs.io/en/v5.0/schema_specifications/stimulation/stimulus/ephysStimulus.html>`_
