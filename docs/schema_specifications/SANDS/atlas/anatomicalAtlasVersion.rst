...
For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/anatomicalAtlasVersions/WHSSDatlas.html>`_.
...
.. admonition:: schema_specifications
   ...
   :value type: | linked object of type
                | `AnatomicalAtlas <https://openminds-documentation.readthedocs.io/en/latest/schema_specifications/SANDS/atlas/anatomicalAtlas.html>`_
