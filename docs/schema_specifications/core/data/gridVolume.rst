...
:Optional: `additionalRemarks <additionalRemarks_heading_>`_, `capturedWith <capturedWith_heading_>`_, `name <name_heading_>`_, `numberOfPlanes <numberOfPlanes_heading_>`_
...
.. admonition:: schema_specifications
   ...
   :instructions: Add the device used to capture this grid volume.
