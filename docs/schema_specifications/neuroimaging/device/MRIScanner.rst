...
:Semantic name: https://openminds.om-i.org/types/MRIScanner

:Display as: Mriscanner
...
:Required: `contribution <contribution_heading_>`_, `magneticFieldStrength <magneticFieldStrength_heading_>`_, `name <name_heading_>`_, `type <type_heading_>`_
...
.. _magneticFieldStrength_heading:
...
.. admonition:: schema_specifications
   ...
   :semantic name: https://openminds.om-i.org/props/magneticFieldStrength
