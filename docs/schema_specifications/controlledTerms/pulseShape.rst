...
:Semantic name: https://openminds.om-i.org/types/PulseShape

:Display as: Pulse shape


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/pulseShape.html>`_.
