...
:Semantic name: https://openminds.om-i.org/types/CommunicationInterfaceType

:Display as: Communication interface type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/terminologies/communicationInterfaceType.html>`_.
...
`BACK TO TOP <CommunicationInterfaceType_>`_
