...
:Semantic name: https://openminds.om-i.org/types/NervousSystemStructure

:Display as: Nervous system structure


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/nervousSystemStructure.html>`_.
...
`BACK TO TOP <NervousSystemStructure_>`_
