...
:Semantic name: https://openminds.om-i.org/types/MRSpatialEncoding

:Display as: Mrspatial encoding


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/MRSpatialEncoding.html>`_.
...
`BACK TO TOP <MRSpatialEncoding_>`_
