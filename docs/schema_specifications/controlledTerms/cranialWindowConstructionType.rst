...
:Semantic name: https://openminds.om-i.org/types/CranialWindowConstructionType

:Display as: Cranial window construction type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/cranialWindowConstructionType.html>`_.
