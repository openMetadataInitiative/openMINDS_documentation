...
:Semantic name: https://openminds.om-i.org/types/PublicationStatus

:Display as: Publication status


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/publicationStatus.html>`_.
...
`BACK TO TOP <PublicationStatus_>`_
