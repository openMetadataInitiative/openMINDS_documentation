...
:Semantic name: https://openminds.om-i.org/types/AnnotationCriteriaType

:Display as: Annotation criteria type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/annotationCriteriaType.html>`_.
