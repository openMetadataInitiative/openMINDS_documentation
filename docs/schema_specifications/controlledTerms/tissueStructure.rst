...
:Semantic name: https://openminds.om-i.org/types/TissueStructure

:Display as: Tissue structure


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/tissueStructure.html>`_.
...
`BACK TO TOP <TissueStructure_>`_
