...
:Semantic name: https://openminds.om-i.org/types/PaymentModelType

:Display as: Payment model type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/paymentModelType.html>`_.
...
`BACK TO TOP <PaymentModelType_>`_
