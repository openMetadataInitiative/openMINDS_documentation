...
:Semantic name: https://openminds.om-i.org/types/ExperimentalApproach

:Display as: Experimental approach


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/experimentalApproach.html>`_.
