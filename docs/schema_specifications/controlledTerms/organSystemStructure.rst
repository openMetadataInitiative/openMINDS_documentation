...
:Semantic name: https://openminds.om-i.org/types/OrganSystemStructure

:Display as: Organ system structure


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/organSystemStructure.html>`_.
...
`BACK TO TOP <OrganSystemStructure_>`_
