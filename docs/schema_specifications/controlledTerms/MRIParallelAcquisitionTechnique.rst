...
:Semantic name: https://openminds.om-i.org/types/MRIParallelAcquisitionTechnique

:Display as: Mriparallel acquisition technique


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/MRIParallelAcquisitionTechnique.html>`_.
...
`BACK TO TOP <MRIParallelAcquisitionTechnique_>`_
