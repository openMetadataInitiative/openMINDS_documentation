...
:Semantic name: https://openminds.om-i.org/types/SupranationalBody

:Display as: Supranational body


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/terminologies/supranationalBody.html>`_.
...
`BACK TO TOP <SupranationalBody_>`_
