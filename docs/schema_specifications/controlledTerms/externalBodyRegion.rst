...
:Semantic name: https://openminds.om-i.org/types/ExternalBodyRegion

:Display as: External body region


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/externalBodyRegion.html>`_.
