...
:Semantic name: https://openminds.om-i.org/types/TypeOfUncertainty

:Display as: Type of uncertainty


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/typeOfUncertainty.html>`_.
