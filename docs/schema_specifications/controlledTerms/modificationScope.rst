...
:Semantic name: https://openminds.om-i.org/types/ModificationScope

:Display as: Modification scope


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/modificationScope.html>`_.
...
`BACK TO TOP <ModificationScope_>`_
