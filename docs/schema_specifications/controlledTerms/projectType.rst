...
:Semantic name: https://openminds.om-i.org/types/ProjectType

:Display as: Project type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/projectType.html>`_.
