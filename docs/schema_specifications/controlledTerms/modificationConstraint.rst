...
:Semantic name: https://openminds.om-i.org/types/ModificationConstraint

:Display as: Modification constraint


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/modificationConstraint.html>`_.
...
`BACK TO TOP <ModificationConstraint_>`_
