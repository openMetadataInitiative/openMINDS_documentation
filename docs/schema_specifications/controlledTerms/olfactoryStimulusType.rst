...
:Semantic name: https://openminds.om-i.org/types/OlfactoryStimulusType

:Display as: Olfactory stimulus type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/olfactoryStimulusType.html>`_.
