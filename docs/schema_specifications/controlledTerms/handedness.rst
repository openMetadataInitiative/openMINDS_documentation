...
:Semantic name: https://openminds.om-i.org/types/Handedness

:Display as: Handedness


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/handedness.html>`_.
