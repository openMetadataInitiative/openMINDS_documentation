...
:Semantic name: https://openminds.om-i.org/types/AnalysisTechnique

:Display as: Analysis technique


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/analysisTechnique.html>`_.
