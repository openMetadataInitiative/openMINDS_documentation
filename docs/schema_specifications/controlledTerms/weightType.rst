...
:Semantic name: https://openminds.om-i.org/types/WeightType

:Display as: Weight type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/weightType.html>`_.
