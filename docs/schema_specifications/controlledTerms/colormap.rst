...
:Semantic name: https://openminds.om-i.org/types/Colormap

:Display as: Colormap


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/colormap.html>`_.
