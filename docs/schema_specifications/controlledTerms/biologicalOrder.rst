...
:Semantic name: https://openminds.om-i.org/types/BiologicalOrder

:Display as: Biological order


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/biologicalOrder.html>`_.
