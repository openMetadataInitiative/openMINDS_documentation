...
:Semantic name: https://openminds.om-i.org/types/VascularStructure

:Display as: Vascular structure


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/vascularStructure.html>`_.
...
`BACK TO TOP <VascularStructure_>`_
