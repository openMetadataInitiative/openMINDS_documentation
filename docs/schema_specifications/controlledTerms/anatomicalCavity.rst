...
:Semantic name: https://openminds.om-i.org/types/AnatomicalCavity

:Display as: Anatomical cavity


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/anatomicalCavity.html>`_.
...
`BACK TO TOP <AnatomicalCavity_>`_
