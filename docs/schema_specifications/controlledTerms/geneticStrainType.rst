...
:Semantic name: https://openminds.om-i.org/types/GeneticStrainType

:Display as: Genetic strain type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/geneticStrainType.html>`_.
