...
:Semantic name: https://openminds.om-i.org/types/CellCultureType

:Display as: Cell culture type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/cellCultureType.html>`_.
