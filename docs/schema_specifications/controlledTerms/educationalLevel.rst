...
:Semantic name: https://openminds.om-i.org/types/EducationalLevel

:Display as: Educational level


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/educationalLevel.html>`_.
