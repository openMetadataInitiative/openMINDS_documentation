...
:Semantic name: https://openminds.om-i.org/types/StimulationTechnique

:Display as: Stimulation technique


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/stimulationTechnique.html>`_.
