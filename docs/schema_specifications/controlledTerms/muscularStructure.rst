...
:Semantic name: https://openminds.om-i.org/types/MuscularStructure

:Display as: Muscular structure


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/muscularStructure.html>`_.
...
`BACK TO TOP <MuscularStructure_>`_
