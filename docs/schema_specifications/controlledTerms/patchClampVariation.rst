...
:Semantic name: https://openminds.om-i.org/types/PatchClampVariation

:Display as: Patch clamp variation


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/patchClampVariation.html>`_.
