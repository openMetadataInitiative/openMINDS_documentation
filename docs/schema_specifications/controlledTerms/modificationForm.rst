...
:Semantic name: https://openminds.om-i.org/types/ModificationForm

:Display as: Modification form


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/modificationForm.html>`_.
...
`BACK TO TOP <ModificationForm_>`_
