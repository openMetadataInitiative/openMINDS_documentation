...
:Semantic name: https://openminds.om-i.org/types/MeasuredSignalType

:Display as: Measured signal type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/measuredSignalType.html>`_.
...
`BACK TO TOP <MeasuredSignalType_>`_
