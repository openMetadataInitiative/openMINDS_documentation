...
:Semantic name: https://openminds.om-i.org/types/DeviceMountingType

:Display as: Device mounting type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/deviceMountingType.html>`_.
...
`BACK TO TOP <DeviceMountingType_>`_
