...
:Semantic name: https://openminds.om-i.org/types/TissueSampleAttribute

:Display as: Tissue sample attribute


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/tissueSampleAttribute.html>`_.
