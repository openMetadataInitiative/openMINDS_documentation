...
:Semantic name: https://openminds.om-i.org/types/AccessEligibilityType

:Display as: Access eligibility type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/accessEligibilityType.html>`_.
...
`BACK TO TOP <AccessEligibilityType_>`_
