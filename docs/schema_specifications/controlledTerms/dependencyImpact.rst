...
:Semantic name: https://openminds.om-i.org/types/DependencyImpact

:Display as: Dependency impact


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v5.0/instance_libraries/terminologies/dependencyImpact.html>`_.
...
`BACK TO TOP <DependencyImpact_>`_
