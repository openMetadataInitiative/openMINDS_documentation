...
:Semantic name: https://openminds.om-i.org/types/ModificationConsentRequirement

:Display as: Modification consent requirement


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/modificationConsentRequirement.html>`_.
...
`BACK TO TOP <ModificationConsentRequirement_>`_
