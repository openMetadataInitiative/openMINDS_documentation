...
:Semantic name: https://openminds.om-i.org/types/AnatomicalIdentificationType

:Display as: Anatomical identification type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/v4.0/instance_libraries/terminologies/anatomicalIdentificationType.html>`_.
