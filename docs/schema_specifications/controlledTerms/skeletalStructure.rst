...
:Semantic name: https://openminds.om-i.org/types/SkeletalStructure

:Display as: Skeletal structure


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/skeletalStructure.html>`_.
...
`BACK TO TOP <SkeletalStructure_>`_
