...
:Semantic name: controlledTerms:ModelScope

:Display as: Controlled terms:model scope


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/modelScope.html>`_.
