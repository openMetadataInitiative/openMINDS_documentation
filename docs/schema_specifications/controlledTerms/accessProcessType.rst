...
:Semantic name: https://openminds.om-i.org/types/AccessProcessType

:Display as: Access process type


For this schema openMINDS provides a `library of instances <https://openminds-documentation.readthedocs.io/en/latest/instance_libraries/terminologies/accessProcessType.html>`_.
...
`BACK TO TOP <AccessProcessType_>`_
