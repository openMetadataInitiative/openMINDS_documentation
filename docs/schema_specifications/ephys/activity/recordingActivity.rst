...
.. admonition:: schema_specifications
   ...
   :value type: | linked object array \(1-N\) of type
                | `ElectrodeArrayUsage <https://openminds-documentation.readthedocs.io/en/v3.0/schema_specifications/ephys/device/electrodeArrayUsage.html>`_, `ElectrodeUsage <https://openminds-documentation.readthedocs.io/en/v3.0/schema_specifications/ephys/device/electrodeUsage.html>`_ or `PipetteUsage <https://openminds-documentation.readthedocs.io/en/v3.0/schema_specifications/ephys/device/pipetteUsage.html>`_
