...
:Optional: `configuration <configuration_heading_>`_, `copyright <copyright_heading_>`_, `custodian <custodian_heading_>`_, `description
   <description_heading_>`_, `developer <developer_heading_>`_, `digitalIdentifier <digitalIdentifier_heading_>`_, `entryPoint <entryPoint_heading_>`_,
   `fullName <fullName_heading_>`_, `funding <funding_heading_>`_, `homepage <homepage_heading_>`_, `howToCite <howToCite_heading_>`_, `isAlternativeVersionOf
   ...
   `otherContribution <otherContribution_heading_>`_, `referenceData <referenceData_heading_>`_, `relatedPublication <relatedPublication_heading_>`_,
   `repository <repository_heading_>`_, `supportChannel <supportChannel_heading_>`_
...
.. admonition:: specifications
   ...
   :value type: | linked object of type
                | `Configuration <https://openminds.ebrains.eu/core/Configuration>`_, `File <https://openminds.ebrains.eu/core/File>`_, `PropertyValueList
                <https://openminds.ebrains.eu/core/PropertyValueList>`_ or `WebResource <https://openminds.ebrains.eu/core/WebResource>`_
...
.. admonition:: specifications
   ...
   :value type: | linked object array \(1-N\) of type
                | `Consortium <https://openminds.ebrains.eu/core/Consortium>`_, `Organization <https://openminds.ebrains.eu/core/Organization>`_ or `Person
                <https://openminds.ebrains.eu/core/Person>`_
   :instructions: Add all parties that developed this validation test version. Note that these developers will overwrite the developer list provided for the
      overarching validation test.
...
.. admonition:: specifications
   ...
   :value type: | linked object array \(1-N\) of type
                ...
                <https://openminds.ebrains.eu/core/FileBundle>`_ or `WebResource <https://openminds.ebrains.eu/core/WebResource>`_
